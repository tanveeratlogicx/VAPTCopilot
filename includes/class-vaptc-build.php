...
class VAPTC_Build
{
  ...
  public static function generate($data)
  {
    ...
    $config_content .= "define( 'VAPTC_DOMAIN_LOCKED', '" . esc_sql($domain) . "' );\n";
    $config_content .= "define( 'VAPTC_BUILD_VERSION', '" . esc_sql($version) . "' );\n\n";

    foreach ($features as $key) {
      $config_content .= "define( 'VAPTC_FEATURE_" . strtoupper($key) . "', true );\n";
    }
    ...
    $guide_template = VAPTC_PATH . 'data/user-guide-template.md';
    ...
    VAPTC_DB::record_build($domain, $version, $features);

...
/**
 * VAPTM_Enforcer: The Global Security Hammer
 * 
...
class VAPTC_Enforcer
{
  ...
  public static function runtime_enforcement()
  {
    ...
    require_once VAPTC_PATH . 'includes/enforcers/class-vaptm-hook-driver.php';
  ...
  public static function dispatch_enforcement($key, $data)
  {
    ...
    switch ($driver_name) {
      case 'htaccess':
        require_once VAPTC_PATH . 'includes/enforcers/class-vaptm-htaccess-driver.php';
